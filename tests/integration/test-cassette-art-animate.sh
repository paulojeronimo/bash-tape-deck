...
TERM=xterm COLUMNS=80 LINES=24 CASSETTE_ANIMATION_DELAY=0 \
  ./tools/cassette-art.sh --clear-screen --center --animate 2 --width 48 --label TEST >"$stdout_file" 2>"$stderr_file"
...
if ./tools/cassette-art.sh --animate 0 --width 48 --label TEST >"$invalid_stdout_file" 2>"$invalid_stderr_file"; then
...
TERM=xterm COLUMNS=80 LINES=24 \
  ./tools/cassette-art.sh --clear-screen --center --width 88 --label TEST >"$static_stdout_file" 2>"$static_stderr_file"
...
TERM=xterm COLUMNS=80 LINES=24 \
  ./tools/cassette-art.sh --center top --width 48 --label TEST >"$top_stdout_file" 2>"$top_stderr_file"
TERM=xterm COLUMNS=80 LINES=24 \
  ./tools/cassette-art.sh --center bottom --width 48 --label TEST >"$bottom_stdout_file" 2>"$bottom_stderr_file"
TERM=xterm COLUMNS=80 LINES=24 CASSETTE_ANIMATION_DELAY=0 \
  ./tools/cassette-art.sh --title-preset future-metal --animate 1 --width 48 --label TEST >"$metal_stdout_file" 2>"$metal_stderr_file"
TERM=xterm COLUMNS=80 LINES=24 \
  ./tools/cassette-art.sh --width 88 --project-title "My Tape" --project-url "example.com/my-tape" >"$project_stdout_file" 2>"$project_stderr_file"
TERM=xterm COLUMNS=80 LINES=24 CASSETTE_ANIMATION_DELAY=0 \
  ./tools/cassette-art.sh --animate 1 --width 48 --label TEST --subtitle SUB >"$subtitle_stdout_file" 2>"$subtitle_stderr_file"
...
if ./tools/cassette-art.sh --center middle --width 48 --label TEST >"$invalid_center_stdout_file" 2>"$invalid_center_stderr_file"; then
